...
```{r}
#topics_tbl with doc_id (document number identifier which should match the one contained in io_corpus), original (original post title), topic( the topic number assigned by the LDA), probability (the probability that document belongs to that topic)
